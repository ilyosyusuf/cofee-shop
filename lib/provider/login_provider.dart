...
import 'package:coffeeshop/widgets/my_messenger.dart';
...
class LoginProvider extends ChangeNotifier {
  Future signIn(BuildContext context, String emailController,
    ...
    try {
      ...
      UserCredential credential =
        ...
        password: passwordController,
            ...
            if(emailController == 'ilyosyusufforweb@gmail.com' && passwordController == '1234567'){
    ...
    Future register(BuildContext context,String emailController, String passwordController) async {
    try{
      ...
      if(e.code == 'weak-password'){
        ...
        MyMessenger.messenger(context,"Bu Email bilan oldir ro'yxatdan o'tilgan", Colors.red);
      }
    }
  }
  ...
  Future forgotPassword(BuildContext context,String emailController) async{
    ...
    MyMessenger.messenger(context,'Yangi parol uchun link e-mail pochtanggizga jo\'natildi', Colors.orange);
  } 


  Future printWhere() async{
    List where1 = [];
    var where =  await FireService.store.collection('coffee').where('name').get();
